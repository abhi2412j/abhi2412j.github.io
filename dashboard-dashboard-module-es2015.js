...
DashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _filter_pipe__WEBPACK_IMPORTED_MODULE_6__["FilterPipe"], _header_header_component__WEBPACK_IMPORTED_MODULE_9__["HeaderComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"],
            ngx_pagination__WEBPACK_IMPORTED_MODULE_11__["NgxPaginationModule"], _shared_material_module__WEBPACK_IMPORTED_MODULE_12__["MaterialModule"]
        ]
    })
], DashboardModule);
...
let EmployeedetailsComponent = class EmployeedetailsComponent {
    ...
    getDataFromBackend(eid) {
        this.service.getEmployeeById(eid).subscribe((response) => {
            // console.log(response);
...
let HomeComponent = class HomeComponent {
    ...
    GetDataFromBackend() {
        this.service.getEmployee().subscribe((respose) => {
            this.empdata = respose;
    ...
    onUpdate(popup) {
        if (this.radioCheck()) {
            ...
            alert("Please select any one record to update.....!");
    }
    onDelete() {
        if (this.radioCheck()) {
