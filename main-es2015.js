...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<img src=\"../../assets/error.png\"  height=\"800px\">");
...
const routes = [
    ...
    {
        path: "home", loadChildren: () => __webpack_require__.e(/*! import() | dashboard-dashboard-module */ "dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/dashboard/dashboard.module.ts")).then(m => m.DashboardModule)
    },
    {
...
/* harmony import */ var _shared_material_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./shared/material.module */ "./src/app/shared/material.module.ts");
...
/* harmony import */ var _shared_mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./shared/mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
let HttpService = class HttpService {
    ...
    getEmployeeById(eid) {
        return (this.http.get(`${this.BaseUrl}getEmployee/${eid}`));
    }
    getCountry() {
    ...
    updateStatus(obj) {
        return (this.http.put(`${this.BaseUrl}updateStatus`, obj, { responseType: 'text' }));
    }
};
...
/* harmony import */ var _mat_confirm_dialog_mat_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mat-confirm-dialog/mat-confirm-dialog.component */ "./src/app/shared/mat-confirm-dialog/mat-confirm-dialog.component.ts");
...
module.exports = __webpack_require__(/*! D:\FrontEnd\Angular\project\src\main.ts */"./src/main.ts");
